...
$SCP ../vm-scripts/mk-img-test-luks-pg100-blank.sh $VM:/tmp/test-luks
$SSH /tmp/test-luks/mk-img-test-luks-pg100-blank.sh
$SCP $VM:/tmp/test-luks/test-luks-pg100.write.img ..
