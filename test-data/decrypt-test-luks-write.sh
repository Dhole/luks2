...
$SCP ../test-luks-write.img $VM:/tmp/test-luks
$SCP ../vm-scripts/decrypt-test-luks-write.sh $VM:/tmp/test-luks
$SSH /tmp/test-luks/decrypt-test-luks-write.sh
$SCP $VM:/tmp/test-luks/pg100-decrypted.img ..
